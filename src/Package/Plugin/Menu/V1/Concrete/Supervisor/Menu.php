<?php
namespace Ababilithub\FlexSupervisor\Package\Plugin\Menu\V1\Concrete\Supervisor;
...
if (!class_exists(__NAMESPACE__.'\Menu')) 
{
    ...
    class Menu extends BaseMenu
    {
        ...
        public function add_menu_items($menu_items = [])
        {
            $menu_items[] = [
                'type' => 'menu',
                'page_title' => 'Flex Supervisor',
                'menu_title' => 'Flex Supervisor',
                'capability' => 'manage_options',
                'menu_slug' => 'flex-supervisor',
