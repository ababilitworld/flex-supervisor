<?php
namespace Ababilithub\FlexSupervisor\Package\Plugin\Menu\V1\Concrete\Audit\Term;
    ...
    class Menu extends BaseMenu
    {
        ...
        public function add_menu_items($menu_items = [])
        {
            ...
            $menu_items[] = [
                ...
                'menu_slug' => 'flex-supervisor-audit-term',
                'callback' => [$this->termAudit, 'render'],
                'position' => 3,
            ];
